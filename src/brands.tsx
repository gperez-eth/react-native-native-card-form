...
import type { BrandRendererProps, CardBrand } from './types';
...
const marks: Record<Exclude<CardBrand, 'unknown'>, React.ComponentType> = {
  visa: Visa,
...
export function DefaultBrand({ brand, accessibilityLabel }: BrandRendererProps) {
  if (brand === 'unknown') {
    return (
      <View style={frame} accessible accessibilityLabel={accessibilityLabel} pointerEvents="none">
